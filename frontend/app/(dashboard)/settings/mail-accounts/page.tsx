            ...
            <div style={{display:'flex',flexDirection:'column',gap:'12px'}}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'6px'}}>
                {[
                  ...
                  ['Recruitment','<b>Your Name</b><br>Senior Recruiter - Aviin Tech<br>📧 email@aviintech.com | 📱 +91 98765 43210<br><i style="color:#64748b;font-size:12px">Connecting Talent with Opportunity</i>'],
